...
namespace CyberTech.Api.Controllers
{
        ...
        IPublishEndpoint publishEndpoint, ILogger<TeamController> logger) : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] CreatingTeamModel creatingTeamModel)
        {
        ...
        /// <returns></returns>
        [HttpPut("{id:guid}")]
        public async Task<IActionResult> EditAsync(Guid id, [FromBody] UpdatingTeamModel updatingTeamModel)
        {
