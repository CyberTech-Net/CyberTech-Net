...
namespace CyberTech.Api.Controllers
{
        ...
        IPublishEndpoint publishEndpoint, ILogger<PlayerController> logger) : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> AddAsync([FromBody] CreatingPlayerModel creatingPlayerModel)
        {
        ...
        /// <returns></returns>
        [HttpPut("{id:guid}")]
        public async Task<IActionResult> EditAsync(Guid id, [FromBody] UpdatingPlayerModel updatingPlayerModel)
        {
