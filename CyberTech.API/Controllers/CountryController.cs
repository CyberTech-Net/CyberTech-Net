...
namespace CyberTech.API.Controllers
{
        ...
        IPublishEndpoint publishEndpoint, ILogger<CountryController> logger) : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] CreatingCountryModel creatingCountryModel)
        {
        ...
        /// <returns></returns>
        [HttpPut("{id:guid}")]
        public async Task<IActionResult> EditAsync(Guid id, [FromBody] UpdatingCountryModel updatingCountryModel)
        {
